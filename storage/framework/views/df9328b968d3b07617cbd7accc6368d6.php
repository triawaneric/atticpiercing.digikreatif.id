<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 space-y-6 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-1/4">
            <p class="text-gray-600">Total Products: <?php echo e($productCount); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('product.detail', $product->id)); ?>" class="block">
                <div class="bg-white shadow-md rounded-xl overflow-hidden transition-transform transform hover:scale-105 hover:shadow-lg">
                    ...
                    <div class="p-6">
                        <h2 class="text-xl font-semibold text-gray-800"><?php echo e($product->name); ?></h2>
                        <p class="text-gray-600 mt-2"><?php echo e(Str::limit($product->description, 100)); ?></p>
                        <div class="flex justify-between items-center mt-4">
                            <span class="text-lg font-semibold text-gray-900">
                                RM
                                <?php echo e((floor($product->original_price) == $product->original_price)
                                    ? number_format($product->original_price, 0)
                                    : number_format($product->original_price, 2)); ?>

                            </span>
                            <button
                                wire:click="addToCart(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', <?php echo e($product->original_price); ?>)"
...
</div><?php /**PATH /Users/triawaneric/Work/DIgiKreatif/atticpiercing/resources/views/livewire/product-list.blade.php ENDPATH**/ ?>