...
<div class="footer-wrapper bg-white text-black py-12">
    <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-8 text-center sm:text-left">
            <!-- Logo -->
            <div>
                <img src="<?php echo e(asset('storage/images/logo/attic-logo.png')); ?>" alt="Logo" class="h-12 mx-auto sm:mx-0">
            ...
            <div>
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-4">
                        <a href="/branch/<?php echo e($outlet->id); ?>"
            ...
            <div>
                ...
                <div class="flex justify-center space-x-4 sm:justify-start">
                    <img src="<?php echo e(asset('storage/images/logo/maestro.png')); ?>" alt="Maestro" class="h-8">
                    <img src="<?php echo e(asset('storage/images/logo/mastercard.png')); ?>" alt="Mastercard" class="h-8">
                    <img src="<?php echo e(asset('storage/images/logo/visa.png')); ?>" alt="Visa" class="h-8">
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center text-sm">
            <!-- Copyright (Kiri) -->
            <p class="text-gray-600">&copy; <?php echo e(date('Y')); ?> Attic. All rights reserved.</p>
...
</div><?php /**PATH /Users/triawaneric/Work/DIgiKreatif/atticpiercing/resources/views/livewire/footer.blade.php ENDPATH**/ ?>